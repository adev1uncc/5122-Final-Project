...
if page == 'Introduction':
    st.write('Air pollution is one of the many big problems in the world. Its the release of pollutants into the air, which are hazardous to human health and the planet. There are number of types and causes of Air Pollution created by the human race and by nature as shown in the images below. The majority of air pollution comes from energy use and production. Such as burning fossil fuels, which releases gases and chemicals into the air. To take a look at the average value of air pollutants and the causes, go to the next page.')
